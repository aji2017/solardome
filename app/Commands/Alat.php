...
class Alat extends BaseCommand
{
    protected $group       = 'alat';
    protected $name        = 'alat:push';
    protected $description = 'Kontrol ON/OFF Sistem Alat melalui MQTT';
    ...
    public function __construct(LoggerInterface $logger, Commands $commands)
    {
        ...
        $this->statusFile = WRITEPATH . 'alat_status.json';
    }
    ...
    public function run(array $params)
    {
        ...
        $port     = 8883;
        $clientId = 'solardome_kontrol_alat-' . uniqid(); // Client ID unik dan tetap
        $username = 'admin';
        $password = 'admin';
        ...
        echo "🚀 Starting system status monitoring loop...\n";

        while (true) {
            try {
                if (!file_exists($this->statusFile)) {
                    echo "⚠️  alat_status.json not found!\n";
                    sleep(3);
                    continue;
                }
